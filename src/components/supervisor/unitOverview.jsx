...
function createDetail(building_name, description, price ) {
	return {
		building_name, description, price
	};
}
										...
										.map((row, index) => {
											...
											return (
												...
												>
													...
													<TableCell ><Button variant="outlined" onClick={()=>(handleEditClick())}	style={{color:'white', borderColor:'white'}}>Edit Unit</Button></TableCell>
												</TableRow>
											);
										})}
									{emptyRows > 0 && (
						...
						<Paper sx={{ width: '100%', mb: 2 }}>
							...
							<TableContainer>
								<Table sx={{ minWidth: 750 }}
									...
									<TableRow>
										<TableCell variant="head">Unit Price</TableCell>
										<TableCell>{rows2[0].price}</TableCell>
										<TableCell ><Button variant="outlined"	style={{color:'white', borderColor:'white'}}>Edit</Button></TableCell>
									</TableRow>
									<TableRow>
										<TableCell variant="head">Facilities</TableCell>
										<TableCell><Button variant="outlined"	style={{color:'white', borderColor:'white'}}>Detail Facilities</Button></TableCell>
										<TableCell ><Button variant="outlined"	style={{color:'white', borderColor:'white'}}>Edit</Button></TableCell>
									</TableRow>
										<TableRow>
