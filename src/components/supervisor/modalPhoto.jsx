				...
				{/*<Fade in={open}>*/}
					<Box sx={style}>
						<Carousel autoPlay={false}>
							{
								exterior.map( (item, i) => <Item key={i} building={building} handleClose={handleClose} item={item}/> )
							}
						</Carousel>
...
function Item(props)
{
	...
	const handleFirebase = () => {
		let reqFirebase = `/images/building/${props.building?.id}/exterior/${idExt}`
	...
	const handleUpdatePhoto = () => {
		...
		let imageFromFirebase = `https://firebasestorage.googleapis.com/v0/b/ofspace-project.appspot.com/o/images%2Fbuilding%2F${props.building?.id}%2Fexterior%2F${idExt}?alt=media&token=62809c58-ff5a-4f54-a813-9b42b18364fe`
