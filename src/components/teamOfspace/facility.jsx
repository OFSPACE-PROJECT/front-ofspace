...
export default function Facility() {
	...
	const handleCreateFacility = () => {
		...
		axios
			.post(
				`http://3.142.49.13:8080/facility`,
				{
					name: newFacility,
				},
				{
	...
	return (
		<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
										...
										.map((row, index) => {
											...
											return (
												...
												>
													...
													<TableCell ><Button variant="outlined"  id={row.id} onClick={(e)=>(handleAdd(e))} style={{color:'white', borderColor:'white'}}>Edit</Button></TableCell>
												</TableRow>
											);
										})}
									{emptyRows > 0 && (
			...
			{isOn? <Box display='flex' mb={10}>
				<TextField onChange={(e)=> setNewFacility(e.target.value)} label="New Facility" variant="outlined" name="name" value={newFacility}/>
				<Box>
					<Button variant="outlined" 	style={{color:'black', borderColor:'white'}} onClick={()=>setNewFacility('')}>Cancel</Button>
					<Button variant="outlined" 	style={{color:'black', borderColor:'white'}} onClick={()=>handleCreateFacility()}>Save</Button></Box>
			</Box>: null}
		</div>
	)
}